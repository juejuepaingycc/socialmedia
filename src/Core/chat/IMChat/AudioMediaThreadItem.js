...
export default function AudioMediaThreadItem(props) {
  const { appStyles, item, own, outBound } = props;
  ...
  if(own){
    return (
      <View style={styles.mm}>
        <View style={styles.audioMediaThreadItemContainer}>
          ...
          {isLoading ? (
            <ActivityIndicator color={styles.minimumAudioTrackTintColor.color} size="small" />
          ) : (
            ...
            <View style={styles.audioDateView}>
              <Text style={styles.at}>{props.date}</Text>
              <Text style={styles.at}>{props.time}</Text>
            </View>
        </View>
    ...
    return (
      <View style={styles.nn}>
        <View style={styles.theiraudioMediaThreadItemContainer}>
            <TouchableOpacity
              disabled={isLoading}
              onPress={onPlayPausePressed}
              style={styles.audioPlayPauseIconContainer}>
