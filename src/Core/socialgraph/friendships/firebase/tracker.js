...
import { setUsers, setUserData, setAllUsers } from '../../../onboarding/redux/auth';
...
export default class FriendshipTracker {
  ...
  addFriendRequest = (outBound, toUser, notiMessage, type, callback) => {
  ...
  updateUsers = (users) => {
    ...
    this.allUsers = users;
    this.reduxStore.dispatch(setAllUsers(this.allUsers));
    if (bannedUserIDs) {
