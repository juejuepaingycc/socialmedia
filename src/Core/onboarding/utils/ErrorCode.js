...
export const localizedErrorMessage = (errorCode) => {
  switch (errorCode) {
    ...
    case ErrorCode.noUser:
      return IMLocalized('There is no user record corresponding to this identifier');
    ...
    case ErrorCode.smsNotSent:
      return IMLocalized('The SMS was not sent due to an error');
    case ErrorCode.invalidSMSCode:
      return IMLocalized('The verification code is invalid');
    default:
      return IMLocalized('An error came up while logging you in');
  }
};
